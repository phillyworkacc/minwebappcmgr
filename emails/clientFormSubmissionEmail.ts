      ...
      <div class="email-wrap">
         <div class="email-body" role="article" aria-roledescription="email">
            ...
            <div class="header">
               ...
               <div class="greeting" style="color:#ffffff">Hi Philip — ${clientName} just submitted a client form, have a look by clicking below</div>
            </div>
            ...
            <div class="content">
                  ...
                  <tr class="activity-row" role="listitem">
                     ...
                     <div style="display:flex; justify-content:space-between; align-items:flex-start; gap:12px;">
                        <div style="flex:1; min-width:0;">
                           ...
                           <div class="activity-meta">Email: ${clientEmail}</div>
                           <div class="activity-meta">Phone Number: ${clientPhone}</div>
                           <div class="activity-meta">Preferred Contact Method: ${clientPCM}</div>
                        </div>
                     </div>
                     </td>
                  </tr>
               ...
               <p style="margin-top:18px;">
                  <a href="${baseurl}/client-form/${clientFormId}" target="_blank" style="display:inline-block; padding:10px 14px; border-radius:8px; background-color:#1121ff !important; color:#fff !important; font-weight:600;" class="dashboard-btn">
                     View Client Form Submission
                  </a>
               </p>
            </div>
